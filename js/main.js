...
gameData={prefix:"manhtu.caro.",records:{},addRecord:function(t,e,n){this.records[t]=e;var o;o=n?n:function(){},Object.defineProperty(this,t,{get:function(){return localStorage[this.prefix+t]},set:function(e){o(e),localStorage[this.prefix+t]=e}})},ini:function(){for(var t in this.records)this[t]=this.records[t]},apply:function(){for(var t in this.records)this[t]=this[t]}},
